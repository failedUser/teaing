...
@implementation YYdataDict
-(instancetype)initWithCapacity:(NSUInteger)numItems
{
    self = [super initWithCapacity:200];
    if (self) {
...
-(void)add
{
    ...
    NSMutableDictionary * dict11 = [NSMutableDictionary dictionaryWithObjectsAndKeys:@"又一个机智的我",@"playerName",@"好吧，上面那句话的主人 也是我",@"saidWord",@"10",@"numberOf",@"fewgegw",@"objectId", nil];
      [self setObject:dict forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict2 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict3 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict4 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict5 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict6 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict7 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict8 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict9 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict10 forKey:[dict objectForKey:@"numberOf"]];
        [self setObject:dict11 forKey:[dict objectForKey:@"numberOf"]];
}@end
